predicted_p2 = zeros(size(p2));
for i=20:420
m = armax(p2(1:i),[2,1])
predicted_p2(i+1) = forecast(m,p2(1:i),1);
disp(i)
end
predicted_p2(1:20) = p2(1:20);
...
predicted = zeros(size(p1));
for i=20:420
m = armax(p1(1:i),[2,1])
predicted(i+1) = forecast(m,p1(1:i),1);
disp(i)
end
hold off
plot(validDate,p1)
...
Plant = ss(A,[B G],C,D,-1,'inputname',{'u' 'w'},'outputname','y');
